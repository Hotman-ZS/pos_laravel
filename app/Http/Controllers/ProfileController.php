...
class ProfileController extends Controller
{
    ...
    public function changePassword(Request $request)
    {
        ...
        // jika password lama berbeda , 12345678, 12345
            if(!Hash::check($request->old_password, $user->password)) {
                Alert()->error('Failed Change', 'Old Password is Wrong!');
                return back();    
            }
            $user->update([
            ...
            Alert()->success('Success', 'Password Changed Success');
            return back();  
    }
    ...
    public function changeProfile(Request $request)
    {
        ...
        // Upsert ; jika datanya blm ada maka insert, else <
        try {
            UserDetail::upsert(
            [
                        [
                    ...
                    ['user_id'],
                    ['phone', 'about', 'company', 'job', 'address','photo']
            );
