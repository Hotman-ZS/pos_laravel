            ...
            <div class="col-xl-4">
                ...
                <div class="card">
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                        ...
                        @else
                            <img src="{{ asset('asset/img/user-detail.png') }}" alt="Profile" class="preview">
                        @endif
                        <h2>{{ $user->name ?? '' }}</h2>
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            @if ($userDetail->photo)
                                                <img src="{{ asset('storage/' . $userDetail->photo) }}" alt="Profile"
                                                    class="preview">
                                            @else
                                                <img src="{{ asset('asset/img/user-detail.png') }}" alt="Profile"
                                                    class="preview">
                                            @endif
                                            <div class="pt-2">
                                                ...
                                                <a href="#" class="btn btn-danger btn-sm"
                                                    title="Remove my profile image"><i class="bi bi-trash m-3"></i></a>
                                            </div>
                                        </div>
                                    </div>
