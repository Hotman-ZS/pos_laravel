...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/css/aldo.css') }}">
...
<body>
            ...
            <div class="col-md-7 product-section">
                ...
                <div class="mb-5">
                    <button class="btn btn-outline-secondary category-btn active"
                        onclick="filterCategory('all', this)">All Menu</button>
            ...
            <div class="col-md-5 cart-section">
                ...
                <div class="cart-footer">
                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-6">
                            <button class="btn btn-checkout btn-outline-primary w-100" onclick="processPayment()">
    ...
    <script src="{{ asset('assets/js/aldo.js') }}"></script>
